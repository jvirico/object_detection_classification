...
//		// "/home/avsa/datasets/...
	...
	string dataset_path = "C:/Users/javier.rico/Desktop/IPCV/UAM/AVSA/AVSA2020datasets";
...
//		string image_path = "/input/in%06d.jpg"; //path to images - this format allows to read consecutive images with filename inXXXXXX.jpq (six digits) starting with 000001
	...
	string project_root_path = "C:/Users/javier.rico/Desktop/IPCV/UAM/AVSA/Lab2/AVSA2020results/";
	...
	for (int c = 0; c < NumCat; c++)
	{
		...
		for (int s = 0; s < NumSeq; s++)
		{
			...
			for (;;) {
				...
				//extractBlobs_floodFill(fgmask, bloblist, connectivity);
				//extractBlobs_Optional1(fgmask, bloblist, connectivity);
				...
				//classifyBlobs_Optional2(frame, fgmask, bloblistFiltered);
